...
const mk = (children: React.ReactNode, sw = 1.7): React.FC<IconProps> => {
  const Icon = function Icon({ size = 22, ...props }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
const mkFilled = (children: React.ReactNode): React.FC<IconProps> => {
  const Icon = function Icon({ size = 22, ...props }: IconProps) {
    return (
...
IconDigital.displayName = 'IconDigital';
...
IconMentor.displayName = 'IconMentor';
