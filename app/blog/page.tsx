...
export const metadata: Metadata = {
  title: 'Blog & Stories',
  description: 'Student spotlights, session recaps, and programme updates from Club chapters across Africa.',
  openGraph: { title: 'Blog & Stories | Club', description: 'Voices from the club, student stories and chapter updates.' },
};
