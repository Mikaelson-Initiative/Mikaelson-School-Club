...
const SECTIONS = [
  ...
  { heading: 'Your Rights', content: (<p>You have the right to request access to, correction of, or deletion of personal data we hold about you at any time. To exercise these rights, please email{' '}<a href="mailto:msc@mikaelsoninitiative.org" className="text-accent-ink">msc@mikaelsoninitiative.org</a>. We will respond within 14 days.</p>) },
  { heading: 'Contact', content: (<p>For any privacy-related enquiries, please contact us at{' '}<a href="mailto:msc@mikaelsoninitiative.org" className="text-accent-ink">msc@mikaelsoninitiative.org</a>.</p>) },
];
